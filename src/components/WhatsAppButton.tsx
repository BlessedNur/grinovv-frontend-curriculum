...
const WhatsAppButton: React.FC = () => {
  ...
  const message = "Hello! I'm interested in your services at Grace Innovation Computer Training Center.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 animate-pulse hover:animate-none"
